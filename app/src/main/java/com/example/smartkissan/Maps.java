...
public class Maps extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (userLocation != null) {
                    ...
                    editor.putString(PREF_ENTERED_ADDRESS, address);
                    editor.apply();

                    Intent intent = new Intent(Maps.this, AddCrop.class);
                    startActivity(intent);
                } else {
                    Toast.makeText(Maps.this, "Please select a location on the map", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        findViewById(R.id.btnNormalMap).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        findViewById(R.id.btnSatelliteMap).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        findViewById(R.id.btnTerrainMap).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent back = new Intent(Maps.this, AddCrop.class);
                startActivity(back);
            }
        });
